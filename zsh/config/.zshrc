...
# Enable ('yes') or disable ('no') automatic integration with iTerm2.
...
alias ls="${aliases[ls]:-eza} -lah"
alias ll="${aliases[ll]:-eza} -lah"
alias llt="${aliases[ll]:-eza} -T"
...
# pnpm
export PNPM_HOME="/Users/jerem/Library/pnpm"
case ":$PATH:" in
  *":$PNPM_HOME:"*) ;;
